...
PRODUCT_COPY_FILES += \
    ...
    $(LOCAL_PATH)/configs/audio/sku_holisound_trigger_platform_info.xml:$(TARGET_COPY_OUT_VENDOR)/etc/sku_holisound_trigger_platform_info.xml \
...
# Inherit vendor
$(call inherit-product, vendor/poco/peux/peux-vendor.mk)